...
const Index = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-32 relative overflow-hidden">
        ...
        <div className="orbit-container relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              <div className="inline-flex items-center px-3 py-1 rounded-full bg-orbit-purple/20 text-orbit-purple text-sm font-medium mb-4 animate-fade-in">
      ...
      <section id="how-it-works" className="orbit-section bg-muted/30">
        <div className="orbit-container">
      ...
      <section id="testimonials" className="orbit-section">
        <div className="orbit-container">
          ...
          <div className="mt-16 text-center opacity-0 reveal-on-scroll">
            <a href="#case-studies" className="inline-flex items-center text-orbit-purple font-medium hover:text-orbit-lightPurple transition-colors">
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-orbit-purple to-orbit-blue opacity-80"></div>
        <div className="glow-effect glow-purple opacity-30 top-20 right-10"></div>
        <div className="glow-effect glow-blue opacity-30 bottom-20 left-10"></div>
        ...
        <div className="orbit-container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-10 opacity-0 animate-fade-in stagger-1">
            ...
            <div className="flex flex-wrap gap-4 justify-center opacity-0 animate-fade-in stagger-2">
              <button className="rounded-lg font-medium transition-all duration-300 py-4 px-8 inline-flex items-center gap-2 bg-white hover:bg-gray-100 text-orbit-purple shadow-lg hover:shadow-xl">
                Start Free Trial
                <ArrowRight size={18} />
              </button>
